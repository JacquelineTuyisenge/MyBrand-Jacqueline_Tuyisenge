        ...
        <section class="comments">
            <div class="comment-like">
                ...
                <div class="like-nbr">
                    ...
                    <i class='bx bxs-heart ${blog.isLiked ? 'liked' : ''}' onclick="toggleLike('${blog._id}', this)"></i>
                </div>
            </div>
...
async function addComment(blogId) {
    loader.style.display = "block";
    try{
        const commentContent = document.querySelector(".comment-place textarea").value.trim();
